<div class="box box-danger">
    ...
    <div class="box-body">
    <form class="form-group" method="post" action="<?= base_url() ?>slider/delete/<?= $update_id ?>">
    	<input type="hidden" name="update_id" value="<?= $update_id ?>" />
		<p><?= $this->lang->line('are_sure'); ?></p>
		<hr>

		<input type="submit" name="submit" class="btn btn-danger" value="<?= $this->lang->line('del_slider'); ?>" />
