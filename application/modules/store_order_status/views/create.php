 ...
 if (is_numeric($update_id)): ?>
  <div class="box box-default">
    ...
    <div class="box-body">
      ...
      <a href="<?= base_url() ?>store_order_status/deleteconif/<?= $update_id ?>" class="btn btn-danger"><?= $this->lang->line('delete_order_status_option') ?></a>
...
<div class="box box-success">
	...
	<form role="form" method="post" action="<?php echo base_url(); ?>store_order_status/create">
	<input type="hidden" name="update_id" value="<?php echo isset($update_id) ? $update_id : ''; ?>" />
        <div class="form-group">
            <label><?= $this->lang->line('status_title') ?></label>
            <input type="text" name="status_title" value="<?php echo $status_title; ?>" class="form-control" placeholder="<?= $this->lang->line('enter_status_title') ?>">
        </div>
