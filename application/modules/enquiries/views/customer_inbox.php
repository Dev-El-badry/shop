...
<h1><?php $folder_type ?></h1>
 ...
 <a href="<?php echo base_url(); ?>yourmessages/create" class="btn btn-primary">    Compose Message</a>
<br> <br>
 <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-striped">
                ...
                foreach ($query->result() as $row) {
                    ...
                    $code = $row->code;     
                    if($sent_by == 0) {
                      $customer_name = $this->site_settings->_get_support_team_name(); 
                    } else {      
                    ...
                    $view_url = base_url() . 'yourmessages/view/' . $code;
                ?>
                ...
                <tr>
                   ...
                   echo  $this->timedate->get_nice_date($date_created, 'cool');
                    ...
                    <td><?= $subject ?></td>
                    <td>
                      <a href="<?= $view_url ?>" title="Open" class="btn btn-default">View <i class="fa fa-eye fa-fw"></i></a>
                    </td>
                </tr>
                <?php } ?>
              </table>
