<div class="box box-success">
    ...
    <div class="box-body">
	<p style="color: green">Submit New Option as request. When You Are Finished Adding New Size, Press'Finishing'</p>

	<?php $form_location = base_url()."store_item_sizes/update"; ?>
	...
	<div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?= $row->size ?></td>
                  <td>
                  	<a class="btn btn-danger" href="<?= base_url() ?>store_item_sizes/delete/<?= $row->id ?>" ><i class="fa fa-trash"></i> Delete Size option</a>
                  </td>
                </tr>
                <?php } ?>
            </table>
