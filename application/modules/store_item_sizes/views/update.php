<div class="box box-success">
    ...
    <div class="box-body">
	<p style="color: green"><?= $this->lang->line('msg_size') ?></p>
	...
	<div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?= $row->size ?></td>
                  <td>
                  	<a class="btn btn-danger" href="<?= base_url() ?>store_item_sizes/delete/<?= $row->id ?>" ><i class="fa fa-trash"></i> <?= $this->lang->line('delete_size_option') ?></a>
                  </td>
                </tr>
                <?php } ?>
            </table>
